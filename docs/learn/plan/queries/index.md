...
[QueriesIcon]: media/plan-queries-plan-queries-icon.png
[QueriesMenue]: media/plan-queries-plan-queries-menue-list.png
[QueriesMenueExpanded]: media/plan-queries-plan-queries-menu-expanded.png
[QueryEditorSwitchTypes]: media/plan-queries-plan-query-editor-switch-types.png
[QueryAddNewExpanded]: media/plan-queries-plan-personal-queries-add-new-expanded.png
[QueryNewDialog]: media/plan-queries-plan-new-query.png
[QueryEditor]: media/plan-queries-plan-query-editor.png
[QueryEditorAddField]: media/plan-queries-plan-query-editor-add-field.png
[QueryEditorField3Dots]: media/plan-queries-plan-query-editor-field-three-dots.png
[QueryRun]: media/plan-queries-plan-query-run.png
[QueryResult]: media/plan-queries-plan-query-result.png
[QueryRunBackToEditLink]: media/plan-queries-plan-query-editor-run-back-to-edit.png
[QueryEditFilters]: media/plan-queries-plan-queries-filter.png
[QueryEditFilterCurrentUser]: media/plan-queries-plan-queries-filter-current-user.png
[ButtonSaveClose]: media/plan-queries-plan-query-save-close.png
[ButtonSaveExpanded]: media/plan-queries-plan-query-save-expanded.png
