...
--8<--
learn/plan/ai_assistant/index.md:PLANNewGroup
--8<--

### Configure Plan AI Integrations

Then create the AI integration and associate the group.

--8<--
learn/plan/ai_assistant/index.md:PLANAIIntegration
--8<--
...
--8<--
learn/plan/ai_assistant/index.md:PLANMemberAccess
--8<--

## [Deploy AI Settings](learn/deploy/settings/index.md#ai-settings)

### Switch to Deploy Settings
...
### Configure Deploy Genie

--8<--
learn/deploy/settings/index.md:DeployAIIntegration
--8<--
...
[SBSettings]: learn/introduction/about/media/Loop_Sidebar_Settings.png
[IntegrationsView]: learn/introduction/about/media/Loop_AI_Setup_empty_list.png
[ButtonCreateNewIntegration]:learn/introduction/about/media/Loop_Settings_NewIntegrationsButton.png
[NewIntegrationsDialog]: learn/introduction/about/media/Loop_Settings_IntegrationsNewDialog1.png
[NewIntegrationName]: learn/introduction/about/media/Loop_AI_Setup_Name.png
[NewIntegrationsSelectAIProvider]: learn/introduction/about/media/Loop_AI_setup_Select_Provider.png
[NewIntegrationsDialogNext]: learn/introduction/about/media/Loop_Settings_IntegrationsNewDialog3.png
[NewIntegrationsDialogNextDetails]: learn/introduction/about/media/Loop_AI_Setup_Page_2.png
[ListOfIntegrations]: learn/introduction/about/media/Loop_Settings_Integrations.png
